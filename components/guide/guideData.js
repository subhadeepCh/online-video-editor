const guideData = [
  ...
  {
    title: "STEP 3",
    heading: "Download the clip",
    description:
      "It's done! Now, watch the preview and if you like it, just click \"Download\" (you can also save the result back to Google Drive or Dropbox). Otherwise, go back to editing.",
  },
];
